...
import { SvgEducation, SvgInterests, SvgProgramminSkills, SvgProjects, SvgWorkHistory } from "../../assets/svg";
...
const Resume = (props) => {
	...
	/* STATIC RESUME DATA */
	const resumeBullets = [
		{ label: "Education", logoSrc: SvgEducation },
		{ label: "Work History", logoSrc: SvgWorkHistory },
		{ label: "Programming Skills", logoSrc: SvgProgramminSkills },
		{ label: "Projects", logoSrc: SvgProjects },
		{ label: "Interests", logoSrc: SvgInterests },
	];
			...
			{programmingSkillsDetails.map((skill, index) => (
				<>
					<div className="skill-parent" >
						...
						<div className="skill wow fadeInUp" data-wow-delay={`0.${index * 2}s`} key={index}>
							<p>{skill.skill}</p>
							<div
								className="skill-bar wow slideInLeft animated"
								style={{ width: skill.ratingPercentage + "%" }}
							>
								<span className="skill-count">{skill.ratingPercentage}%</span>
							</div>
						</div>
					</div>
